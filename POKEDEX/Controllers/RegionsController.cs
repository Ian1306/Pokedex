...
namespace POKEDEX.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdRegion,NombreRegion,Color")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRegion,NombreRegion,Color")] Region region)
        {
